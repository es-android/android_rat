...
![Control Panel Main Dashboard](GUI TO BE ADDED HERE)
...
1. Send- Generate the iOS profile payload Request
...
4. Create unique code
5. Select your target platform (Android, iOS, or Windows)
6. Choose your installation method
7. Configure payload settings
8. Generate and download your payload
...
1. Once installed,
2. Enter the unique code
3. The device appears in your control panel
4. Select the device from the device list
5. Choose the feature you want to use
6. Execute commands in real-time
7. Monitor device activity and data
...
- **Target Device**: Android 7.0 to 15, iOS 12+ to iOS 26.2, Windows v7 to v12
